...
export default {
  expo: {
    ...
    extra: {
      ...
      aegisAppId: process.env.AEGIS_APP_ID || 'app-6fd6d3c95e7a16fc717c5895d3b76ee0',
      aegisApiSecret: process.env.AEGIS_API_SECRET || '41c2cdac674030a62122f7e5dffd5d68e6b07053a48263b8cc87286ceefbecf1',
      ...
      aegisPaymasterApiKey: process.env.AEGIS_PAYMASTER_API_KEY || undefined,
      aegisTrackingApiUrl: process.env.AEGIS_TRACKING_API_URL || undefined,
    }
  }
};